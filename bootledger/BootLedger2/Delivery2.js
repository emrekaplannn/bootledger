...
const Delivery2 = ({ route, navigation }) => {
  ...
  useEffect(() => {
    ...
    return await supabase.auth.getSession()
            .then((data, error) => {
               console.log("Got the session at Delivery2:");
      ...
      const checkForOwnership = async() => {
        ...
        if(product){
          ...
          if (product.current_owner){
              console.log("The product belongs to someone.");
  ...
  const handleSendFeedback = async () => {
    ...
    try {
      ...
      setShowBanner(true);
      setTimeout(() => {
        console.log("Delivery taking successful.")
  ...
  return (
    <KeyboardAwareScrollView contentContainerStyle={styles.container}> 
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalTextRed}>IMPORTANT!</Text>
            <Text style={styles.modalText}>This product currently belongs to someone. You can not acquire the ownership of it.</Text>
            <Pressable
      ...
      <TouchableOpacity style={styles.button} onPress={handleSendFeedback}>
        <Text style={styles.buttonText}>I have received</Text>
      </TouchableOpacity>

      {/* Banner */}
      {showBanner && (
        <View style={styles.banner}>
          <Text style={styles.bannerText}>Your reception is submitted</Text>
        </View>
      )}
